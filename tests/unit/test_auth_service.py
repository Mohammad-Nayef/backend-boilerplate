...
from app.common.models.auth import UserRegister
...
def test_auth_service_registration_logic():
    ...
    req = UserRegister(email="exists@test.com", password="password123")
    ...
    clean_req = UserRegister(email="new@test.com", password="password123")
